...
### Intended Use
* **Primary intended uses**: This model can be used to determine the probability that a given individual may default on their payment, and hence be used for determining who may or may not be eligible for a credit line increase in the American population.
* **Primary intended users**: This model may be used by credit companies and other lenders who determine eligibility for credit line increases in the United States.
* **Out-of-scope use cases**: Any use beyond determining eligibility for credit line increases in the United States is out of scope.
